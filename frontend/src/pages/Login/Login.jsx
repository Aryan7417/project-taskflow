        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 relative">
          ...
          <div className="w-full max-w-[420px] glass-panel rounded-xl p-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant mb-8">Sign in to your account to continue.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center pt-2">
                  <input 
                    className="h-4 w-4 rounded border-outline-variant bg-[#0e1a10] text-primary focus:ring-primary focus:ring-offset-0 focus:ring-offset-background" 
                    id="remember-me" 
                    name="remember-me" 
                    type="checkbox"
                    checked={rememberMe}
                  ...
                  />
                  <label className="ml-3 block font-body-md text-body-md text-on-surface-variant" htmlFor="remember-me">
              ...
              <p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
                ...
                <Link className="font-label-md text-label-md text-primary hover:underline hover:text-primary-fixed ml-1 font-semibold" to="/register">Sign Up</Link>
              </p>
            </div>
          </div>
        </div>
